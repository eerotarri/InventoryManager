import editNavigate from "../../assets/images/instructions/edit-navigate.png";
import editForm from "../../assets/images/instructions/edit-form.png";
  ...
  return (
    <>
      <ol className="space-y-4 list-decimal pl-6 pb-6">
        ...
        <img src={editNavigate} alt="Add item form" />
        <li>
        ...
        <img src={editForm} alt="Add item form" />
      </ol>
    </>
  );
}
